...
class User(models.Model):
    ...
    name = models.CharField(db_column='Name', max_length=30, db_collation='utf8_general_ci')  # Field name made lowercase.
    email = models.CharField(db_column='Email', max_length=100, db_collation='utf8_general_ci')  # Field name made lowercase.
    password_hash = models.CharField(db_column='Password_hash', max_length=64)  # Field name made lowercase.
